...
Installing "WordPress Plugin Shell" can be done either by searching for "WordPress Plugin Shell" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
